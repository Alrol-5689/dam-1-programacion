...
public class Córdoba_Alejandro_act_ev_T1 {
	...
	public static void main(String[] args) {
				...
				do { // COMIENZO DEL BUCLE ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							...
							opcion=sc.next();  // PREGUNTO LA CLASE A LA QUE PERTENECE Y LO ALMACENO EN OPCION
							...
							if(!opcion.toUpperCase().equals("X") && (opcion.toUpperCase().equals("A") || // AÑADIMOS PARÉNTESIS AGRUPANDO LAS OPCIONES "OR" SEPARADAS DEL "AND" 
							                                         ...
							                                         opcion.toUpperCase().equals("C") || // SI HA INTRODUCIDO UN VALOR CORRECTO EL PROGRAMA CONTINUA
						    	                                     opcion.toUpperCase().equals("D"))
							 ) { 
								

									System.out.print("\nCuántas horas has trabajado este mes? ");
									// NO CONSIGO EVITAR LA EXCEPCIÓN CUANDO SE INTRODUCE TXT EN VEZ DE UN NUMERO CORRECTO DE HORAS POR CONSOLA
									horas=sc.nextInt();
									
									// CÁLCULO DEL SALARIO SIN RETENCIONES:
									...
									// CALCULAMOS EL SALARIO NETO DEPENDIENDO DE SUS INGRESOS
							...
							// SI HA INTRODUCIDO UNA "X" O UN VALOR INVÁLIDO SIGUE A PARTIR DE AQUÍ 
